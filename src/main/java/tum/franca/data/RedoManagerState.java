 ...
 *
 */
public class RedoManagerState implements Serializable {
	...
	public void importState(File file) {
		RedoManagerState e = null;
		try {
			FileInputStream fileIn = new FileInputStream(file);
			ObjectInputStream in = new ObjectInputStream(fileIn);
			e = (RedoManagerState) in.readObject();
	...
	public void setState(TabPaneSetter tabpane) {
